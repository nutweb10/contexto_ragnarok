...
const translations = {
    en: {
        ...
        how_to_play_title: "How to Hunt",
        how_to_play_desc: "Enter any monster trait (Name, Map, Drops, Race, Property, or Size). The system will calculate a 'Clue Score' from 0-100 based on the hidden target. Use the Logbook on the left to organize your findings and narrow down the pursuit.",
        highlights_title: "Why Join the Hunt?",
        highlights_desc: "Experience the nostalgia of Episode 14.3 Hi-Class with accurate data. It's not just a game of luck, but a test of your knowledge and detective skills in the world of Rune-Midgard.",
        thanks_desc: "This project wouldn't be possible without the incredible support from the RO fan community. Your passion for the game keeps this project alive. Thank you for being part of the hunt!",
        community_title: "Community",
        community_desc: "Join our Discord to chat with other hunters, share tips, and get the latest updates.",
        community_discord: "Join Discord",
        privacy_title: "Privacy Policy",
        privacy_last_updated: "Last updated: April 6, 2026",
        privacy_intro: "At RO Monster Hunt (accessible from roguess.online), your privacy is important to us. This document explains the types of information we collect and how we use it to provide a better hunting experience.",
        privacy_sec1_title: "1. Information We Collect",
        privacy_sec1_desc: "We do not collect any personal identifiable information (PII) such as your name, email address, or phone number. The information we process includes:",
        privacy_sec1_li1: "Anonymous Game Stats: We record successful hunts, failed hunts, and guess counts to generate global community statistics via Firebase Firestore.",
        privacy_sec1_li2: "Local Preferences: Your language choice (TH/EN) is stored locally on your device via localStorage to maintain consistency.",
        privacy_sec1_li3: "Log Files: Like most websites, we use standard log files provided by our hosting services to monitor traffic and site performance.",
        privacy_sec2_title: "2. Google AdSense & Cookies",
        privacy_sec2_desc: "Google is a third-party vendor on our site. It uses cookies, known as DART cookies, to serve ads based on your visit to this and other sites on the internet. We use Google AdSense to display advertisements to support the development of this project.",
        privacy_sec2_optout: "You can choose to opt-out of personalized advertising by visiting Google Ad Settings.",
        privacy_sec3_title: "3. Third-party Services",
        privacy_sec3_desc: "Our site utilizes professional third-party services to ensure stability and functionality:",
        privacy_sec3_li1: "Firebase (Google Cloud): Used for secure storage of global game intelligence data.",
        privacy_sec3_li2: "GitHub Pages: Our hosting provider for serving site content.",
        privacy_sec4_title: "4. Consent",
        privacy_sec4_desc: "By using our website, you hereby consent to our Privacy Policy and agree to its terms.",
        privacy_contact: "If you have any questions, feel free to visit our About Page.",
        rank_none: "No Trace",
    ...
    th: {
        ...
        how_to_play_title: "วิธีเข้าล่า",
        how_to_play_desc: "ใส่ข้อมูลมอนสเตอร์ที่คุณสงสัย (ชื่อ, แผนที่, ไอเทม, เผ่า, ธาตุ หรือขนาด) ระบบจะคำนวณ 'คะแนนเบาะแส' (Clue Score) ตั้งแต่ 0-100 ยิ่งคะแนนสูงแสดงว่ามอนสเตอร์ตัวนั้นใกล้เคียงกับเป้าหมายมาก ใช้ 'Monster Logbook' ทางซ้ายเพื่อวิเคราะห์และแยกแยะข้อมูลให้แม่นยำขึ้น",
        highlights_title: "เสน่ห์ของการล่า",
        highlights_desc: "สัมผัสความคลาสสิกของข้อมูล Episode 14.3 Hi-Class ที่เราคุ้นเคย เกมนี้คือการทดสอบความจำและไหวพริบในฐานะนักล่าแห่ง Rune-Midgard พร้อมระบบสถิติชุมชนที่แชร์ความสำเร็จร่วมกัน",
        thanks_desc: "โปรเจกต์นี้เกิดขึ้นได้เพราะกำลังใจและแรงสนับสนุนจากกลุ่มเพื่อนๆ แฟนคลับทุกท่าน ขอบคุณที่ร่วมสนุกและทำให้โลกของ RO ยังคงมีชีวิตชีวาในทุกวันนี้ครับ!",
        community_title: "ชุมชนนักล่า",
        community_desc: "เข้าร่วม Discord ของเราเพื่อพูดคุยกับนักล่าคนอื่นๆ แบ่งปันเทคนิค และรับข่าวสารล่าสุด",
        community_discord: "เข้าช่อง Discord",
        privacy_title: "นโยบายความเป็นส่วนตัว",
        privacy_last_updated: "อัปเดตล่าสุด: 6 เมษายน 2026",
        privacy_intro: "ที่ RO Monster Hunt (เข้าถึงได้จาก roguess.online) ความเป็นส่วนตัวของคุณเป็นสิ่งสำคัญสำหรับเรา เอกสารนี้จะอธิบายถึงประเภทของข้อมูลที่เราจัดเก็บและวิธีที่เราใช้เพื่อมอบประสบการณ์การเล่นที่ดีขึ้น",
        privacy_sec1_title: "1. ข้อมูลที่เราจัดเก็บ",
        privacy_sec1_desc: "เราไม่มีการจัดเก็บข้อมูลส่วนบุคคลที่ระบุตัวตนได้ (PII) เช่น ชื่อ, อีเมล หรือเบอร์โทรศัพท์ของคุณ ข้อมูลที่เราประมวลผลประกอบด้วย:",
        privacy_sec1_li1: "ข้อมูลสถิติเกมแบบไม่ระบุตัวตน: เราบันทึกจำนวนการล่าที่สำเร็จ, ล้มเหลว และจำนวนการเดา เพื่อนำไปสร้างสถิติรวมของชุมชนผ่าน Firebase Firestore",
        privacy_sec1_li2: "การตั้งค่าส่วนบุคคล: การเลือกภาษาของคุณ (ไทย/อังกฤษ) จะถูกจัดเก็บไว้ในอุปกรณ์ของคุณผ่าน localStorage เพื่อความสะดวกในการใช้งานครั้งถัดไป",
        privacy_sec1_li3: "Log Files: เช่นเดียวกับเว็บไซต์ส่วนใหญ่ เราใช้ไฟล์บันทึกมาตรฐานที่ให้บริการโดยผู้ให้บริการโฮสติ้งเพื่อตรวจสอบปริมาณการเข้าใช้งานและประสิทธิภาพของเว็บไซต์",
        privacy_sec2_title: "2. Google AdSense และคุกกี้ (Cookies)",
        privacy_sec2_desc: "Google เป็นผู้ให้บริการภายนอกบนเว็บไซต์ของเรา โดยมีการใช้คุกกี้ที่เรียกว่า DART cookies เพื่อแสดงโฆษณาตามการเยี่ยมชมเว็บไซต์นี้และเว็บไซต์อื่นๆ บนอินเทอร์เน็ต เราใช้ Google AdSense เพื่อแสดงโฆษณาเพื่อสนับสนุนการพัฒนาโปรเจกต์นี้",
        privacy_sec2_optout: "คุณสามารถเลือกปิดการใช้งานโฆษณาที่ปรับแต่งตามโปรไฟล์ได้ที่ Google Ad Settings",
        privacy_sec3_title: "3. บริการของผู้ให้บริการภายนอก",
        privacy_sec3_desc: "เว็บไซต์ของเราใช้บริการระดับมืออาชีพจากภายนอกเพื่อความเสถียรและฟังก์ชันการทำงาน:",
        privacy_sec3_li1: "Firebase (Google Cloud): ใช้สำหรับการจัดเก็บข้อมูลสถิติเกมระดับโลกอย่างปลอดภัย",
        privacy_sec3_li2: "GitHub Pages: ผู้ให้บริการโฮสติ้งสำหรับการแสดงผลเนื้อหาเว็บไซต์",
        privacy_sec4_title: "4. การยินยอม",
        privacy_sec4_desc: "ในการใช้งานเว็บไซต์ของเรา ถือว่าคุณยินยอมตามนโยบายความเป็นส่วนตัวและยอมรับข้อกำหนดของเรา",
        privacy_contact: "หากคุณมีข้อสงสัย โปรดเยี่ยมชมที่หน้า About ของเรา",
